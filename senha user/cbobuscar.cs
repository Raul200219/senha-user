...
{
    public partial class cbobuscar : Form
    {
        public cbobuscar()
        {
            InitializeComponent();
        ...
        {
            cboalterar redirectcboalterarform = new cboalterar();
            this.Hide();
            redirectcboalterarform.Show();
        }

        private void btnCadastrarnovo_Click(object sender, EventArgs e)
        {
            cbocadastro redirectcbocadastroform = new cbocadastro();
            this.Hide();
            redirectcbocadastroform.Show();
        }
    }
}
