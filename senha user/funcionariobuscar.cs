...
{
    public partial class funcionariobuscar : Form
    {
        public funcionariobuscar()
        {
            InitializeComponent();
        }
        ...
        {
            funcionarioalterar redirectfuncionarioalterarform = new funcionarioalterar();
            this.Hide();
            redirectfuncionarioalterarform.Show();
        }

        private void btnCadastrarnovo_Click(object sender, EventArgs e)
        {
            funcionariocadastrar redirectfuncionariocadastrarform = new funcionariocadastrar();
            this.Hide();
            redirectfuncionariocadastrarform.Show();
        }
    }
}
