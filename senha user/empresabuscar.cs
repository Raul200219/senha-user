...
{
    public partial class empresabuscar : Form
    {
        ...
        {
            empresaalterar redirectempresaalterarform = new empresaalterar();
            this.Hide();
            redirectempresaalterarform.Show();
        }

        private void btnCadastrarnovo_Click(object sender, EventArgs e)
        {
            empresacadastrar redirectempresacadastrarform = new empresacadastrar();
            this.Hide();
            redirectempresacadastrarform.Show();
        }
    }
}
